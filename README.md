...
`GROQ_API_KEY_5`. Existing numbered names `GROQ_API_KEY1` through
`GROQ_API_KEY5` are also supported. Keys rotate round-robin and are temporarily
cooled down on rate limits, server errors, and timeouts. The default model is
